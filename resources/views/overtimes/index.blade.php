        ...
        <table class="w-full text-left border-collapse">
            ...
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="p-2 text-center">TotalOnDay</th>
                    <th class="p-2 text-center">TotalOffDay</th>
            ...
            <tbody>
                ...
                <tr class="border-t hover:bg-gray-50">
                    <td class="p-1 text-center">{{ $ot->employee->name }}</td>
                    ...
                    <td class="p-1 text-center">{{ $ot->date }}</td>
                    <td class="p-1 text-center">
